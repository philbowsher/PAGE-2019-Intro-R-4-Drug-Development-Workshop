...
### You will learn:
- Setup including the Tidyverse & nlmixr
...
- Day 1 concentrations of the Theophiline data that is included in nlmixr
- data(theo_sd)
- ?theo_sd
- theo_sd
- View(theo_sd)
...
## Your Turn 1_Intro_Notebook.Rmd
- Explore theo_sd
- Rpubs
- 1_Intro_Notebook.Rmd.Rmd in nlmixr folder has examples but change them
